...
<div class="wp-block-group"><!-- wp:query {"queryId":18,"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false}} -->
...
<!-- wp:post-template {"textColor":"paragraph","layout":{"type":"grid","columnCount":3}} -->
<!-- wp:group {"style":{"spacing":{"blockGap":"0px"}},"layout":{"inherit":false}} -->
<div class="wp-block-group"><!-- wp:group {"className":"single-post-over-flow-hidden","layout":{"type":"constrained"}} -->
<div class="wp-block-group single-post-over-flow-hidden"><!-- wp:post-featured-image {"height":"300px","style":{"border":{"radius":{"topRight":"129px"}}},"className":"single-post-img"} /--></div>
<!-- /wp:group -->
...
<!-- wp:post-content {"style":{"typography":{"fontSize":"18px","fontStyle":"normal","fontWeight":"400"}},"textColor":"paragraph"} /-->

<!-- wp:read-more {"content":"Read the Post","style":{"elements":{"link":{"color":{"text":"var:preset|color|button-hover"}}}},"textColor":"button-hover","className":"read-the-post"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
