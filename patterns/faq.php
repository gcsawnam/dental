...
<h2 class="wp-block-heading has-hover-color has-text-color has-link-color has-kanit-font-family" style="margin-bottom:var(--wp--preset--spacing--50);font-size:48px;font-style:normal;font-weight:600;line-height:1">MURFREESBORO PRESSURE WASHING TN FAQs</h2>
<!-- /wp:heading -->
