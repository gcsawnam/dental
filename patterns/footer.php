...
<p class="has-text-align-left" style="font-size:20px"><?php echo esc_html__( 'Best Patient Care', 'dental' ); ?>&nbsp;<strong><?php echo esc_html__( '2017', 'dental' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"20px"}}} -->
<p class="has-text-align-left" style="font-size:20px"><?php echo esc_html__( 'Best Practice', 'dental' ); ?> &amp; <?php echo esc_html__( 'Team', 'dental' ); ?>&nbsp;<strong><?php echo esc_html__( '2016', 'dental' ); ?></strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"20px"}}} -->
<p class="has-text-align-left" style="font-size:20px"><?php echo esc_html__( 'Best Patient Care', 'dental' ); ?>&nbsp;<strong><?php echo esc_html__( '2014', 'dental' ); ?></strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
...
<!-- wp:social-links {"style":{"spacing":{"blockGap":{"left":"var:preset|spacing|20"}}}} -->
...
<!-- wp:social-link {"url":"www.linkin.com","service":"linkedin"} /-->
